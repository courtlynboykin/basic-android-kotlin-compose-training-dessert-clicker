...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewModel: DessertClickerViewModel by viewModels()
        setContent {
            DessertClickerTheme {
...
private fun DessertClickerApp(
    dessertViewModel: DessertClickerViewModel,
    onDessertButtonClicked: () -> Unit
) {
    ...
    Scaffold(
        ...
        DessertClickerScreen(
            ...
            onDessertClicked = onDessertButtonClicked,
